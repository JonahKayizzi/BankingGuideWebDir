            ...
            <div id="login" class="col-sm-5">
				...
				<legend>Login</legend>
					...
					<form class="form-horizontal" role="form" action="${loginUrl}" method="post">       
					    ...
					    <div class="form-group">
					    	<label class="control-label col-sm-4" for="remember_me">Remember Me?</label>
					    	<div class="col-sm-1"><input style="margin-top:10px" type="checkbox" id="remember-me" name="remember-me" value="true"/></div>
					    </div>					    
